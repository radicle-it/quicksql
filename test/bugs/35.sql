...
create table app_feature_items (
    ...
    feature_master_id    number                         constraint app_feature_items_feature_master_id_fk
...
is
    ...
    procedure get_row (
        p_id        in  integer,
        p_feature_master_id   out  integer,
        p_name   out  varchar2
    );

    procedure insert_row (
        p_id        in  integer default null,
        p_feature_master_id    in  integer default null,
        p_name    in  varchar2 default null
    );
...
is
    ...
    is 
    begin 
        select feature_master_id,
               name
          into p_feature_master_id,
               p_name
          from app_feature_items
         where id = p_id;
    exception
        when no_data_found then
            null;
...
-- Generated by Radicle QuickSQL development 20/04/2026, 15:16:22
...
app_feature_items
 ...
 Non-default options:
# settings = {"pk":"identityDataType","api":"y"}
